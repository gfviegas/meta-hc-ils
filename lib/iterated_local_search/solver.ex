defmodule Meta.IteratedLocalSearch.Solver do
  @moduledoc """
  Attempt to find a local maximum/minimum value using ILS and HillClimbing as a local searcher.
  ...
  # Client
   @doc """
  Generates a IteratedLocalSearch `GenServer` process to solve the problem.
  ...
  # Examples
          ...
          problem: %Meta.Problem{
            ...
            variables: [
              %Meta.Problem.Variable{
                name: :x,
                constraint: %Meta.Problem.Constraint{lower_boundary: -1.5, higher_boundary: 4}
              },
              %Meta.Problem.Variable{
                name: :y,
                constraint: %Meta.Problem.Constraint{lower_boundary: -3, higher_boundary: 4}
              }
            ],
          },
          hc_options: [
      ...
      iex> Meta.IteratedLocalSearch.Solver.setup(opts)
      {:ok, #PID<>}
  """
  ...
  @doc """
  Solves for IteratedLocalSearch the problem configured in the provided `pid` server.
  ...
  ```
      15:28:26.504 mfa=Meta.IteratedLocalSearch.Solver.handle_continue/2 [info]  Solution #1: %Meta.Problem.Solution{value: 51.660402502492126, variables: [%Meta.Problem.Variable{constraint: %Meta.Problem.Constraint{higher_boundary: 10, lower_boundary: 0}, name: :x, value: 7.187517130587733}]}

      15:28:26.504 mfa=Meta.IteratedLocalSearch.Solver.handle_continue/2 [info]  Solution #2: %Meta.Problem.Solution{value: 80.21040204576592, variables: [%Meta.Problem.Variable{constraint: %Meta.Problem.Constraint{higher_boundary: 10, lower_boundary: 0}, name: :x, value: 8.956026018595855}]}

      15:28:26.504 mfa=Meta.IteratedLocalSearch.Solver.handle_continue/2 [info]  Solution #3: %Meta.Problem.Solution{value: 49.492197212573195, variables: [%Meta.Problem.Variable{constraint: %Meta.Problem.Constraint{higher_boundary: 10, lower_boundary: 0}, name: :x, value: 7.035069097924568}]}

      ...

      15:28:26.529 mfa=Meta.IteratedLocalSearch.Solver.handle_continue/2 [info]  Solution #197: %Meta.Problem.Solution{value: 6.841908964815985e-11, variables: [%Meta.Problem.Variable{constraint: %Meta.Problem.Constraint{higher_boundary: 10, lower_boundary: 0}, name: :x, value: 8.271583261272285e-6}]}

      15:28:26.529 mfa=Meta.IteratedLocalSearch.Solver.handle_continue/2 [info]  Solution #198: %Meta.Problem.Solution{value: 4.2071463961827206e-11, variables: [%Meta.Problem.Variable{constraint: %Meta.Problem.Constraint{higher_boundary: 10, lower_boundary: 0}, name: :x, value: 6.4862519193928325e-6}]}

      15:28:26.529 mfa=Meta.IteratedLocalSearch.Solver.handle_continue/2 [info]  Solution #199: %Meta.Problem.Solution{value: 5.924935935911621e-11, variables: [%Meta.Problem.Variable{constraint: %Meta.Problem.Constraint{higher_boundary: 10, lower_boundary: 0}, name: :x, value: 7.697360544960604e-6}]}

      15:28:26.529 mfa=Meta.IteratedLocalSearch.Solver.handle_continue/2 [info]  Process finished by reason: 'Maximum iterations reached: 200'!
  ```
  # Return values
  ...
  # Examples
      ...
      iex> {:ok, pid} = Meta.IteratedLocalSearch.Solver.setup(opts)
      iex> Meta.IteratedLocalSearch.Solver.solve(pid)
